...
@AllArgsConstructor
public enum SuccessHistorySortField implements SortField {
   ...
   */
  @JsonCreator
  public static SuccessHistorySortField from(String value) {
    return CommonUtil.stringToSortField(SuccessHistorySortField.class, value);
  }
