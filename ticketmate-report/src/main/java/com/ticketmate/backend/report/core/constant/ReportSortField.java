...
@AllArgsConstructor
public enum ReportSortField implements SortField {
   ...
   */
  public static ReportSortField from(String value) {
    return CommonUtil.stringToSortField(ReportSortField.class, value);
  }
